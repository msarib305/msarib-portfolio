...
// scrolls back to the top on click. The class is prefixed `msarib-` because the
// generic `back-to-top` name was hidden by uBlock Origin's cosmetic filters on
// Windows (Phase 24.1, DEC-088).
